...
const Hero = () => {
  ...
  return (
    <div className="relative h-[70vh] flex items-center justify-center overflow-hidden">
      ...
      <button 
        onClick={prevSlide} 
        className="absolute left-4 z-20 bg-black/20 hover:bg-black/40 p-2 rounded-full transition-all duration-300"
      ...
      <button 
        onClick={nextSlide} 
        className="absolute right-4 z-20 bg-black/20 hover:bg-black/40 p-2 rounded-full transition-all duration-300"
      ...
      <div className="relative z-10 text-center text-white px-4 max-w-5xl mx-auto">
        <div className="min-h-[200px] flex items-center justify-center">
          <div className="transition-all duration-500" 
            ...
            <p className="text-xl md:text-2xl mb-20 max-w-3xl mx-auto">
